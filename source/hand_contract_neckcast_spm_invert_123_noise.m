...
filenames=strvcat('D:\MSST001\sub-OP00124\ses-001\meg\rhandoe1000msdfflo45hi5ds_sub-OP00124_ses-001_task-noise_run-001_meg.mat');

posfile='D:\MSST001\sub-OP00124\ses-001\meg\ds_sub-OP00124_ses-001_positions.tsv';
...
dpath='D:\MSST001\sub-OP00124\ses-001\meg'; %data path
savepath='D:\MSST001\Coh_results00123'; %save path
...
for cnd=1 %:size(filenames,1),
    ...
    emgind=find(contains(D.chanlabels,'NI-TRIG-1'));
...
%ryan also suggests plotting norm of lead fields

LF_norms = vecnorm(Lf,2,1); % sum over the channels dimension
Lf_y=LF_norms(yind);

% % 
figure
plot_func_spine_dat(subject,src,Lf_y,grad)
