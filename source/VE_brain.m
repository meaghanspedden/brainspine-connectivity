...
%%choose this if you want to load group avg...
load('C:\Users\mspedden\Documents\brainspine_save\groupRes_brain_DICS.mat')
...
load('brain_group_max_coh.mat')
f=figure; ft_plot_mesh(mesh_brain,'facealpha',0.1);hold on
