%% step_A_brain_VE_M1.m
% Build brain virtual electrode from M1 ROI.
...
savefig(hfig_m1, fullfile(fig_dir, ['stepA_M1_ROI' out_suffix '.fig']));
saveas(hfig_m1,  fullfile(fig_dir, ['stepA_M1_ROI' out_suffix '.png']));
close(hfig_m1);
