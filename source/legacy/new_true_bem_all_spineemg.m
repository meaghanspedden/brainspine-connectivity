%% run_spine_emg_dics_true_bem.m
% Spine-EMG DICS coherence with correct BEM forward model.
% Uses experimental BEM leadfield with label-based channel matching.
% Lambda = 10%, smoothing on (20mm FWHM). All 9 spine subjects.
% Outputs saved with _true_bem suffix to distinguish from old results.
