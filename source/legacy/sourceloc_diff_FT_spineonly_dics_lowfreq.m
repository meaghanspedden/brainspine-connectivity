...
for ss=1:length(subs)
    ...
    if strcmp(sub, 'OP00224') %saved under 002
        datwithEMGmerged = fullfile('C:\Users\mspedden\Documents', ...
            ...
            'ses-001', ...
            'meg', ...
            'pmergedoe1000mspddfflo45hi2hfcstatic_002_array1.mat');
        ...
        datwithEMGmerged = fullfile('C:\Users\mspedden\Documents', ...
            ...
            'ses-001', ...
            'meg', ...
            'pmergedoe1000mspddfflo45hi2hfcstatic_001_array1.mat');
    end
...
% box off;
    ...
    hasSig = any(mask(:)) && any(isfinite(invp_masked(:)));
...
% 
    ...
    % No significant points: choose a valid tiny range, and optionally show nothing
    cfg.funcolorlim = [invpthr, invpthr + eps(invpthr)];
    end
...
save(fullfile(save_dir, 'cluster_spineEMG_pos_lowfreq.mat'), 'ROIpos')
